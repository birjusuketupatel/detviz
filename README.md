# [detviz](https://www.detviz.com/)
#### Birju Patel

The Determinant Visualizer ([detviz](https://www.detviz.com/)) is an interactive teaching tool for the determinant of a matrix.

It presents the determinant as:
...
The current app is a static browser experience in [`docs/`](./docs), built with client-side JavaScript and Three.js for deployment on GitHub Pages.
The original Python / PyVista prototype is preserved in [`misc/`](./misc).
...
- handles singular matrices by showing the degenerate geometry and reporting a determinant of 0
...
- [`misc/`](./misc): legacy Python prototype
